...
public class SearchTestDoner {

    @BeforeTest
    public static void beforetest() {
        System.out.println("BEFORE TEST doner");
        Config.getProperties();
    }

    @BeforeClass
    public static void beforeclass() {
        System.out.println("BEFORE CLASS doner");
    }

    @BeforeSuite
    public static void beforesuite() {
        System.out.println("BEFORE SUITE doner");
    }

    @BeforeMethod
    public static void beforemethod() {
        System.out.println("BEFORE METHOD doner");
    }
