...
public class SearchTestPonchik {

    @BeforeTest
    public static void beforetest() {
        System.out.println("BEFORE TEST ponchik");
        Config.getProperties();
    }

    @BeforeClass
    public static void beforeclass() {
        System.out.println("BEFORE CLASS ponchik");
    }

    @BeforeSuite
    public static void beforesuite() {
        System.out.println("BEFORE SUITE ponchik");
    }

    @BeforeMethod
    public static void beforemethod() {
        System.out.println("BEFORE METHOD ponchik");
    }
